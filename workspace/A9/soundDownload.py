...
if __name__=="__main__":
  ...
  # downloadSoundsFreesound(queryText="guitar", tag="single-note", duration=(0,5), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  # downloadSoundsFreesound(queryText="bassoon", tag="single-note", duration=(0,5), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  # downloadSoundsFreesound(queryText="trumpet", tag="single-note", duration=(0,5), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  # downloadSoundsFreesound(queryText="clarinet", tag="single-note", duration=(0,5), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  downloadSoundsFreesound(queryText="cello", tag="single-note", duration=(0,3), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  # downloadSoundsFreesound(queryText="daluo", tag="", duration=(0,5), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  # downloadSoundsFreesound(queryText="snare", tag="1-shot", duration=(0,3), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  downloadSoundsFreesound(queryText="flute", tag="single-note", duration=(0,3), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')
  # downloadSoundsFreesound(queryText="mridangam", tag="", duration=(0,2), API_Key="chnqxOZ35DAhmdHPAQaOs0bOXFbUNVc5Os0MimA6", outputDir="Data", topNResults=20, featureExt='.json')